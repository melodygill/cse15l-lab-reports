...
Combining commands to copy the directory and run the tests on ieng6 all in one line: (again I cut some of the output because it didn't fit on the screen)
![Image](week6_files/week6_long.png)
![Image](week6_files/week6_long2.png)